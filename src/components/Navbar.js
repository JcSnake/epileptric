            ...
            <header className="main-header">
              <Link to="/" ><img src={logo} className="logo" alt=""/></Link>
                <div className="containerNav">
                    ...
                    >
                        <ul>
                            <li><a href ="#about" className="link" onClick={() => this.closeMenu()}>Acerca de nosotros</a></li>
                            <li><a href="#device" className="link" onClick={() => this.closeMenu()}>Información del Dispostivo</a></li>
                            <li><a href="#contact" className="link" onClick={() => this.closeMenu()}>Contacto</a></li>
                        </ul>
                    </MenuHamburguesa>
                </div>
            </header>
